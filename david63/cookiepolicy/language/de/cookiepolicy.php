...
$lang = array_merge($lang, array(
	'COOKIE_ACCEPT_TEXT'		=> 'Dieses Forum verwendet Cookies zur Verbesserung deines Nutzungserlebnisses. Mit dem Besuch dieses Forums stimmst du dieser Richtlinie zu.<br /><br />Weitere Informationen über verwendete Cookies findest du in der "Cookie-Richtlinie" auf der Foren-Übersicht oder durch Klick auf den nachfolgenden Link.<br /><br />',
	'COOKIE_ACCEPT'			=> '[ Akzeptieren ]',

	'COOKIE_TEXT'			=> '<h3>Wie verwendet dieses Forum Cookies?</h3>
	<p>Wir benutzen auf %1$s Cookie-Dateien zur Leistungssteigerung und zur Verbesserung des Nutzungserlebnisses. Durch deinen Besuch auf %1$s stimmst du der Speicherung dieser Dateien auf deinem Endgerät zu.</p>
...
Cookies können verschiedene Funktionen beinhalten. Ein Cookie ermöglicht es z.B. Webseiten, dein Endgerät beim nächsten Besuch wiederzuerkennen. %1$s benutzt den Begriff “Cookies” in dieser Richtlinie in Bezug auf alle Dateien, die Informationen auf diese Art sammeln.<br /><br />
...
<p><b>3. Funktions-Cookies</b><br />Diese Cookies ermöglichen es uns die Funktionen und Inhalte der Seite auf dich zugeschnitten anzubieten, indem diese Cookies deine Voreinstellungen speichern.</p>
...
<h3>Kann ein Benutzer Cookies blockieren?</h3><p>Informationen zur Verwaltung von Cookies findest du in der Hilfesektion deines Browsers oder im Handbuch deines Smartphones - oder du besuchst die unten aufgeführten Webseiten.<br /><br />
...
<p>Bitte beachte, dass nach der Deaktivierung von Cookies einige Bereiche von %1$s nicht mehr vollständig funktionieren.</p>
<h3>Cookies auf %1$s von Sozialen Netzwerk-Seiten</h3><p>%1$s kann Links von Sozialen Netzwerk-Seiten (z.B. Facebook, Twitter oder YouTube) enthalten. Diese Webseiten können ebenfalls Cookies auf deinem Endgerät platzieren, und %1$s hat keine Kontrolle über die Verwendung dieser Cookies. Daher schlägt %1$s vor, dass du dich auf deren Webseiten darüber informierst, wie Cookies verwendet werden.',
